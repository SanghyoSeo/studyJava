...
<div class="wrapper">
	...
	<div class="row">
		<div class="col-12">
			<table class="table table-bordered table-striped dataTable dtr-inline collapsed">
				...
				<tr class="text-center">
					...
					<td class="dtr-control sorting_1">
						￦<fmt:formatNumber pattern="#,###" value="<%=member.get적립금() %>" />
						<!-- value에 빈칸 조심, 빈칸때문에 포맷을 만들지 못해서 오류  -->
					</td>
				</tr>
					</c:forEach>
				</c:if>
